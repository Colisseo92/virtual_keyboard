...
class Keyboard {
  ...
  Keyboard(
    ...
    List<KeyObject> first_line = [
      ...
      KeyObject(AppLocalizations.of(context)!.key_1_2_1,
          AppLocalizations.of(context)!.key_1_2_2, 1, this.state),
    ...
    List<KeyObject> second_line = [
      ...
      KeyObject(AppLocalizations.of(context)!.key_2_2_1,
          AppLocalizations.of(context)!.key_2_2_2, 1, this.state),
