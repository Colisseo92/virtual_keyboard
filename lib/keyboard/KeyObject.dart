...
class KeyObject{
  ...
  bool is_holdable; //means that it is possible to click once on the key to hold it pressed down.
  bool is_hold; //boolean that represent the state the key is in (hold or not)
  KeyboardState state; //state of the keyboard to track if the shift key is activated
  ...
  void changeHoldState(){
    ...
    this.state = this.state == KeyboardState.normal ? KeyboardState.shifted : KeyboardState.normal;
  }
